...
/**
 * @extends ServiceEntityRepository<FormFactor>
 *
...
class FormFactorRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(FormFactor $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(FormFactor $entity, bool $flush = true): void
    {
