 ...
 */
final class Version20220606163512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE motherboard (id INT AUTO_INCREMENT NOT NULL, form_factor_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, processor_note LONGTEXT DEFAULT NULL, delivery DATETIME DEFAULT NULL, provider_reference VARCHAR(50) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, availability INT DEFAULT NULL, tpm INT DEFAULT NULL, INDEX IDX_7F7A0F2BCD887EAF (form_factor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE processor (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, brand VARCHAR(100) DEFAULT NULL, delivery DATETIME DEFAULT NULL, provider_reference VARCHAR(50) DEFAULT NULL, socket VARCHAR(50) DEFAULT NULL, upi INT DEFAULT NULL, cores INT DEFAULT NULL, threads INT DEFAULT NULL, tdp INT DEFAULT NULL, base_freq INT DEFAULT NULL, boost_freq INT DEFAULT NULL, cache INT DEFAULT NULL, application VARCHAR(50) DEFAULT NULL, url VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, ecc TINYINT(1) DEFAULT NULL, grafics_processor TINYINT(1) DEFAULT NULL, availability INT DEFAULT NULL, max_mem_capacity INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE processor_memory (id INT AUTO_INCREMENT NOT NULL, processor_id INT DEFAULT NULL, memory_id INT DEFAULT NULL, INDEX IDX_DDA5DB1F37BAC19A (processor_id), INDEX IDX_DDA5DB1FCCC80CB3 (memory_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rack_form_factor (id INT AUTO_INCREMENT NOT NULL, rack_id INT NOT NULL, rack_unit_id INT DEFAULT NULL, INDEX IDX_9C80C0148E86A33E (rack_id), INDEX IDX_9C80C0142FCF7EEF (rack_unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE raid_card_level (id INT AUTO_INCREMENT NOT NULL, raid_card_id INT DEFAULT NULL, level_id INT DEFAULT NULL, INDEX IDX_60FBFD055525CBDA (raid_card_id), INDEX IDX_60FBFD055FB14BA7 (level_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE processor_memory ADD CONSTRAINT FK_DDA5DB1F37BAC19A FOREIGN KEY (processor_id) REFERENCES processor (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE processor_memory ADD CONSTRAINT FK_DDA5DB1FCCC80CB3 FOREIGN KEY (memory_id) REFERENCES memory (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE raid_card_interface ADD CONSTRAINT FK_6A9E532B4D085745 FOREIGN KEY (connector_id) REFERENCES connector (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE processor_memory DROP FOREIGN KEY FK_DDA5DB1FCCC80CB3');
        ...
        $this->addSql('ALTER TABLE processor_memory DROP FOREIGN KEY FK_DDA5DB1F37BAC19A');
        ...
        $this->addSql('DROP TABLE processor_memory');
