 ...
 */
final class Version20220505122113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE m2 (id INT AUTO_INCREMENT NOT NULL, interface_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, availability VARCHAR(10) DEFAULT NULL, delivery DATETIME DEFAULT NULL, provider_reference VARCHAR(50) DEFAULT NULL, url VARCHAR(255) NOT NULL, price NUMERIC(14, 2) DEFAULT NULL, INDEX IDX_595D5695AB0BE982 (interface_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE m2_form_factor (m2_id INT NOT NULL, form_factor_id INT NOT NULL, INDEX IDX_470792EE64A268E9 (m2_id), INDEX IDX_470792EECD887EAF (form_factor_id), PRIMARY KEY(m2_id, form_factor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE m2 ADD CONSTRAINT FK_595D5695AB0BE982 FOREIGN KEY (interface_id) REFERENCES form_factor (id)');
        $this->addSql('ALTER TABLE m2_form_factor ADD CONSTRAINT FK_470792EE64A268E9 FOREIGN KEY (m2_id) REFERENCES m2 (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE m2_form_factor ADD CONSTRAINT FK_470792EECD887EAF FOREIGN KEY (form_factor_id) REFERENCES form_factor (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE m2_form_factor DROP FOREIGN KEY FK_470792EECD887EAF');
        $this->addSql('ALTER TABLE motherboard DROP FOREIGN KEY FK_7F7A0F2BCD887EAF');
        $this->addSql('ALTER TABLE m2_form_factor DROP FOREIGN KEY FK_470792EE64A268E9');
        ...
        $this->addSql('DROP TABLE m2_form_factor');
